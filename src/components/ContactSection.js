  ...
  return (
    <div>
      ...
      <div className='contact-section'>
        <a className='contact-links' href="https://www.linkedin.com/in/rakibulislam893/">
        ...
        <a className='contact-links' href="https://www.xing.com/profile/MDRAKIBUL_ISLAM8/cv">
          <div className='contact-svg'>
        ...
        <a className='contact-links' href="https://github.com/raki893">
          <div className='contact-svg'>
        ...
        <a className='contact-links' href="mailto:raki893@gmail.com">
          <div className='contact-svg'>
        ...
        <a className='contact-links' href="https://www.instagram.com/raki.21/">
          <div className='contact-svg'>
        ...
        <a className='contact-links' href="https://www.facebook.com/rakibul.islam.3304">
          <div className='contact-svg'>
